...
export default function App() {
    ...
    // ? print the content of the main div
    function printDiv() {
        window.print();
    }
    ...
    return (
        <>
            <S.Line width="100vw" justify="centers">
                <S.Centered style={{ width: "800px" }} id="invoice">
                    ...
                    <S.Line noPrint top="1em" height="2.6em" justify="start">
                        {printMode && (
                            <S.Line right="4px">
                                <S.Button onClick={() => printDiv()}>
                                    Print
                                </S.Button>
                            </S.Line>
                        )}
            ...
            {!printMode && (
                <S.Line justify="center" top="1em" noPrint>
                    <S.Text size="xx-small">
